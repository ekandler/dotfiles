...
plugins=(git git-extras sudo systemd web-search svn ubuntu zsh-autosuggestions zsh-syntax-highlighting gpg-agent command-not-found common-aliases cp dirhistory tmux)
